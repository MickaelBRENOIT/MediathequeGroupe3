...
@ComponentScan(basePackages = {"com.miage.web.controller", "com.miage.web.conversion"}) // <context:component-scan />
public class SpringWebConfig extends WebMvcConfigurerAdapter {
	...
	public SimpleMappingExceptionResolver exceptionResolver() {
		...
		exceptionMappings.put("com.miage.business.exception.CustomException", "error/custom");
	...
	// Thymeleaf : TemplateResolver <- TemplateEngine <- ViewResolve
	@Bean
